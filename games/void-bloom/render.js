...
window.VoidRender=(()=>{
 ...
 function gem(ctx,g){blit(ctx,stamp('xp',32,32,c=>{glow(c,'#ffe65b',6);c.beginPath();c.arc(0,0,3.5,0,Math.PI*2);c.strokeStyle='#302708';c.lineWidth=2;c.stroke();c.fill();}),g.x,g.y);}
