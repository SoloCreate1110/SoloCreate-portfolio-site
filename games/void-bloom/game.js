...
const supports=[{name:'船体修復',desc:'HPを25回復する。',icon:'＋'},{name:'緊急バリア',desc:'4秒間、橙弾と接触を防ぐ（赤・紫は不可）',icon:'◇'},{name:'弾幕消去',desc:'橙弾を消去＋スコア1,500（赤・紫は残る）',icon:'✳'},{name:'予備補給',desc:'HPを10回復＋スコア500',icon:'⊕'}];
const skills=[
